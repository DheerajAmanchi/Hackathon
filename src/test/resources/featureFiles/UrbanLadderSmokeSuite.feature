Feature: Smoke suite of UrbanLadder Automation
	...
	Scenario: navigating to Bookshelves page
	...
	Scenario: Applying filters on bookshelves
    Given user should naviagate to urbanladder website
		When user enters the search value as "<value>"
		And user click on the search icon
 ...
 Scenario: Navigate to Studychairs Page
    Given user should naviagate to urbanladder website
	...
	Scenario: Get all items under any one of sub-menu items of Living menu item
		Given user should naviagate to urbanladder website
	...
	Scenario: Filling the form with from and to details
		Given user should naviagate to urbanladder website
		When user clicks on Gift Cards
